    ...
    <div className="section">
      <div className="box">
        ...
        <MainText>
          ...
          roof. While (obviously) not very exciting, this concept will allow me
          to familiarize myself with the common web development challenges. The
          project will serve as a foundation for my future progress.
        </MainText>
        <br />
        <MainText>
          I have built this project &quot;from scratch&quot;, meaning no
          boilerplates – just Webpack 4 and stuff (yeah, it has taken time to
          make everything play nicely together).
        </MainText>
        <br />
        <MainText>
          The project structure is heavily inspired by&nbsp;
          <a href="https://hackernoon.com/fractal-a-react-app-structure-for-infinite-scale-4dab943092af">
            &quot;Fractal&quot;
          </a>{' '}
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                fontawesome-free-solid + fontawesome-svg-core +
                react-fontawesome)
              </li>
            </ul>
          </li>
